'use server'
// ============================================================
// LearnHub — Auth server actions
//
// registerAction  → create account (STUDENT by default, role selectable)
// loginAction     → verify credentials + set session cookie (returns role)
// logoutAction    → destroy session cookie + redirect
// ============================================================
...
export type RegisterResult = ActionResult<{ userId: string; role: Role }>

/**
 * Creates a new account. Role is STUDENT by default.
 * Allows 'INSTRUCTOR' to be passed explicitly for the register form role picker.
...
export type LoginResult = ActionResult<{ userId: string; role: Role }>
